...
<hr>
<p><strong>Фронтэнд / Frontend:</strong> JavaScript, CSS3, Sass, HTML5, React, Redux (Saga, Thunk), API, Handlebars, Material-UI, Bootstrap</p>
<p><strong>Бэкэнд / Backend:</strong> Node.js, Express, Sessions, CORS, Typescript (in process)</p>
<p><strong>Базы данных / DB:</strong> PostgreSQL, Sequelize</p>
<p><strong>А также / Another:</strong> Jest, REST</p>
<hr>
